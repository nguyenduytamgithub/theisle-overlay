...
| Installed artifact | NSIS: 6,016,819 bytes, SHA-256 `1BECBE83E5FCBDE3115CB3F32FD6E98520B7CC14C30D2360D784AE6273E0CC50`; installed EXE: 22,163,456 bytes, SHA-256 `69620FB2DF733D84F205084BDC756F49DF46B3D0FE729B8E96ADCE96CF44C4FC`. | `PASS` |
| Running-session preservation | The Isle client PID `36256`, start time `2026-08-31 18:49:24`, remained unchanged; only Overlay restarted to PID `19772`. Previous Overlay EXE is recoverable from `D:\CodexBuild\theisle-overlay-pre-arrow-suppression-20260831-2315`. | `PASS` |
