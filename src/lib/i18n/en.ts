...
export const en: Record<MsgKey, string> = {
  ...
  "settings.night_vision_preset": "Processing preset",
  "settings.night_vision_force_bright": "Force continuous brightening (do not wait for a dark scene)",
  "settings.night_vision_show_button": "Show in-game button",
  "settings.night_vision_hint":
    "The GPU captures only The Isle through Windows Graphics Capture, lifts shadows and protects highlights with a local shader; Magnifier is fallback only. Windowed/Borderless is required. It never reads game memory, injects or hooks code, synthesizes input, saves frames, or sends images over the network.",
  "settings.night_vision_visual": "Native image boost",
  "settings.night_vision_renderer": "Active renderer",
  "settings.night_vision_metrics": "Live measurement",
  "settings.night_vision_gamma": "Legacy gamma (unused)",
  "settings.night_vision_build": "Build fingerprint",
  "night_vision.visual_on": "NATIVE VERIFIED AND VISIBLE",
  "night_vision.visual_off": "NOT ON",
  "night_vision.gamma_on": "Applied",
  "night_vision.gamma_off": "Not applied by design",
  "night_vision.preset_balanced": "Balanced",
  "night_vision.preset_clear": "Clear",
  "night_vision.preset_ultra": "Ultra",
  "night_vision.renderer_none": "Not running",
  "night_vision.renderer_gpu_adaptive": "Adaptive GPU",
  "night_vision.renderer_magnifier_fallback": "Magnifier fallback",
  "night_vision.status_applied": "Native image boost on",
  "night_vision.status_waiting": "Waiting for game",
  "night_vision.status_off": "Off",
  "night_vision.status_unavailable": "Native image boost unavailable",
