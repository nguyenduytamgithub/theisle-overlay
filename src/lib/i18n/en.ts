...
export const en: Record<MsgKey, string> = {
  ...
  "settings.night_vision_hint":
    "Windows Magnification locally redraws displayed screen pixels with higher contrast. Windowed/Borderless is required; high strength can clip highlights and adds composition cost. It never reads game memory, injects or hooks code, synthesizes input, or sends images over the network.",
