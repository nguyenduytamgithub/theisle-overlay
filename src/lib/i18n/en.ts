...
export const en: Record<MsgKey, string> = {
  ...
  "settings.night_vision_hint":
    "A static light layer makes dark areas easier to see; high strength can wash colors out. It never reads game memory or pixels. Alt-Tab or quitting hides it and restores gamma.",
  "settings.night_vision_visual": "Visual boost",
  "settings.night_vision_gamma": "Supplemental gamma",
  "settings.night_vision_build": "Build fingerprint",
  "night_vision.visual_on": "PAINTED AND VISIBLE",
  "night_vision.visual_off": "NOT ON",
  "night_vision.gamma_on": "Applied",
  "night_vision.gamma_off": "Not applied (visual boost still works)",
  "night_vision.status_applied": "Visual boost on",
  "night_vision.status_waiting": "Waiting for game",
  "night_vision.status_off": "Off",
  "night_vision.status_unavailable": "Visual boost unavailable",
