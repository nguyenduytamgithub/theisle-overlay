...
export const vi = {
  ...
  "settings.night_vision_preset": "Mức xử lý",
  "settings.night_vision_force_bright": "Ép sáng liên tục (không chờ tự phát hiện cảnh tối)",
  "settings.night_vision_show_button": "Hiện nút trong game",
  "settings.night_vision_hint":
    "GPU lấy đúng cửa sổ The Isle bằng Windows Graphics Capture, nâng vùng tối và giữ vùng sáng bằng shader cục bộ; Magnifier chỉ là dự phòng. Cần Windowed/Borderless. Không đọc bộ nhớ game, không inject/hook, không giả lập input, không lưu hoặc gửi hình ảnh qua mạng.",
  "settings.night_vision_visual": "Khuếch đại ảnh native",
  "settings.night_vision_renderer": "Bộ dựng đang chạy",
  "settings.night_vision_metrics": "Đo trực tiếp",
  "settings.night_vision_gamma": "Gamma cũ (không dùng)",
  "settings.night_vision_build": "Mã bản dựng",
  "night_vision.visual_on": "NATIVE ĐÃ XÁC MINH VÀ ĐANG HIỆN",
  "night_vision.visual_off": "CHƯA BẬT",
  "night_vision.gamma_on": "Đã áp dụng",
  "night_vision.gamma_off": "Không áp dụng theo thiết kế",
  "night_vision.preset_balanced": "Cân bằng",
  "night_vision.preset_clear": "Rõ",
  "night_vision.preset_ultra": "Ultra",
  "night_vision.renderer_none": "Chưa chạy",
  "night_vision.renderer_gpu_adaptive": "GPU thích ứng",
  "night_vision.renderer_magnifier_fallback": "Magnifier dự phòng",
  "night_vision.status_applied": "Đã bật khuếch đại ảnh native",
  "night_vision.status_waiting": "Đang chờ game",
  "night_vision.status_off": "Đang tắt",
  "night_vision.status_unavailable": "Khuếch đại ảnh native chưa hoạt động",
