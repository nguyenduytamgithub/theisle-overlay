...
export const vi = {
  ...
  "settings.night_vision_hint":
    "Lớp sáng tĩnh làm vùng tối nhìn rõ hơn; mức cao có thể làm màu nhạt. Không đọc bộ nhớ hay hình ảnh game. Alt-Tab hoặc thoát sẽ tự ẩn và phục hồi gamma.",
  "settings.night_vision_visual": "Lớp tăng sáng",
  "settings.night_vision_gamma": "Gamma phụ trợ",
  "settings.night_vision_build": "Mã bản dựng",
  "night_vision.visual_on": "ĐÃ VẼ VÀ ĐANG HIỆN",
  "night_vision.visual_off": "CHƯA BẬT",
  "night_vision.gamma_on": "Đã áp dụng",
  "night_vision.gamma_off": "Không áp dụng (không ảnh hưởng lớp sáng)",
  "night_vision.status_applied": "Đã bật lớp tăng sáng",
  "night_vision.status_waiting": "Đang chờ game",
  "night_vision.status_off": "Đang tắt",
  "night_vision.status_unavailable": "Lớp tăng sáng chưa hoạt động",
