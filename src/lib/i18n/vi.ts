...
export const vi = {
  ...
  "settings.night_vision_hint":
    "Windows Magnification đọc các pixel màn hình đang hiển thị rồi vẽ lại cục bộ với độ tương phản cao hơn. Cần Windowed/Borderless; mức cao có thể cháy vùng sáng và tốn thêm tài nguyên ghép hình. Không đọc bộ nhớ game, không inject/hook, không giả lập input và không gửi hình ảnh qua mạng.",
