...
const INSTRUCTIONS: Record<WaterGuideLanguage, Record<WaterGuideState, string>> = {
  vi: {
    "on-route": "BẢNG XY BẮC CỐ ĐỊNH · SO HAI KIM",
    "off-route": "BẢNG XY BẮC CỐ ĐỊNH · SO HAI KIM",
    lost: "BẢNG XY BẮC CỐ ĐỊNH · SO HAI KIM",
    waiting: "CHỜ TỌA ĐỘ MỚI · KIM GIỮ NGUYÊN",
    "movement-unknown": "ĐI ÍT NHẤT 5 M ĐỂ LẤY HƯỚNG",
    arrived: "ĐÃ TỚI NGUỒN NƯỚC",
    invalid: "KHÔNG XÁC MINH ĐƯỢC NƯỚC UỐNG",
  },
  en: {
    "on-route": "NORTH-UP XY BOARD · MATCH BOTH NEEDLES",
    "off-route": "NORTH-UP XY BOARD · MATCH BOTH NEEDLES",
    lost: "NORTH-UP XY BOARD · MATCH BOTH NEEDLES",
    waiting: "WAITING FOR NEW COORDINATES · NEEDLES FROZEN",
    "movement-unknown": "WALK AT LEAST 5 M TO GET YOUR COURSE",
